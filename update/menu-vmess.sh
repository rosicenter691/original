...
BURIQ () {
    curl -sS https://github.com/hokagelegend9999/ijin/raw/refs/heads/main/alpha > /root/tmp
...
Name=$(curl -sS https://github.com/hokagelegend9999/ijin/raw/refs/heads/main/alpha | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://github.com/hokagelegend9999/ijin/raw/refs/heads/main/alpha | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
